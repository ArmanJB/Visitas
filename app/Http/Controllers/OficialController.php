...
class OficialController extends Controller
{
    ...
    public function listing(){
        $oficiales = DB::select('SELECT oficiales.id, oficiales.nombres, oficiales.apellidos, areas.nombre, oficiales.id_area FROM oficiales, areas WHERE oficiales.id_area = areas.id');
